...
namespace Infrastructure.Tests.Repositories.Tests
{
    public class ImageRepository_Tests
    {
        ...
        {
            var repository = new ImageRepository(_context); //Arrange delen, där jag gör en ny instans av ett lämpligt repository, och skickar in contextet som använder en InMemoryDatabase
            var entity = new Image() { ImageUrl = "Test" }; //Och här skapar jag en ny entitet med lämpliga värden
        ...
        public async Task GetOneAsync_ShouldGetEntityFromTable_And_ReturnEntity()
        {
            ...
            var secondEntity = new Image() { ImageUrl = "Test2" };
            ...
            var result = await repository.GetOneAsync(x => x.ImageUrl == "Test2"); //Act delen, där jag hämtar den andra entiteten från InMemory databasen
        ...
        public async Task DeleteAsync_ShouldDeleteEntity_And_ReturnTrue()
        {
            ...
            var result = await repository.DeleteAsync(x => x.ImageUrl == "Test"); //Act delen, där jag raderar entiteten
